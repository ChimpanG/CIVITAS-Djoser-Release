...
VALUES	('GOVERNOR_PROMOTION_CVS_TJATI',					0,		1,		1,				'LOC_GOVERNOR_PROMOTION_CVS_TJATI_NAME',					'LOC_GOVERNOR_PROMOTION_CVS_TJATI_DESCRIPTION'					),
		('GOVERNOR_PROMOTION_CVS_OVERSEER_OF_STONEWORKS',	1,		0,		0,				'LOC_GOVERNOR_PROMOTION_CVS_OVERSEER_OF_STONEWORKS_NAME',	'LOC_GOVERNOR_PROMOTION_CVS_OVERSEER_OF_STONEWORKS_DESCRIPTION'	),
		('GOVERNOR_PROMOTION_CVS_SEBAYT_AUTHOR',			1,		2,		0,				'LOC_GOVERNOR_PROMOTION_CVS_SEBAYT_AUTHOR_NAME',			'LOC_GOVERNOR_PROMOTION_CVS_SEBAYT_AUTHOR_DESCRIPTION'			),
		('GOVERNOR_PROMOTION_CVS_HEQA_HUT_AA',				2,		0,		0,				'LOC_GOVERNOR_PROMOTION_CVS_HEQA_HUT_AA_NAME',				'LOC_GOVERNOR_PROMOTION_CVS_HEQA_HUT_AA_DESCRIPTION'			),
		('GOVERNOR_PROMOTION_CVS_HIGH_PRIEST_OF_RA',		2,		2,		0,				'LOC_GOVERNOR_PROMOTION_CVS_HIGH_PRIEST_OF_RA_NAME',		'LOC_GOVERNOR_PROMOTION_CVS_HIGH_PRIEST_OF_RA_DESCRIPTION'		),
...
VALUES	('GOVERNOR_PROMOTION_CVS_OVERSEER_OF_STONEWORKS',	'GOVERNOR_PROMOTION_CVS_TJATI'					),
		('GOVERNOR_PROMOTION_CVS_SEBAYT_AUTHOR',			'GOVERNOR_PROMOTION_CVS_TJATI'					),
		('GOVERNOR_PROMOTION_CVS_HEQA_HUT_AA',				'GOVERNOR_PROMOTION_CVS_OVERSEER_OF_STONEWORKS'	),
		('GOVERNOR_PROMOTION_CVS_HIGH_PRIEST_OF_RA',		'GOVERNOR_PROMOTION_CVS_SEBAYT_AUTHOR'			),
		('GOVERNOR_PROMOTION_CVS_IRY_PAT',					'GOVERNOR_PROMOTION_CVS_HEQA_HUT_AA'			),
		('GOVERNOR_PROMOTION_CVS_IRY_PAT',					'GOVERNOR_PROMOTION_CVS_HIGH_PRIEST_OF_RA'		);
...
SELECT	'GOVERNOR_PROMOTION_CVS_OVERSEER_OF_STONEWORKS',
		'MODIFIER_CVS_IMHOTEP_HOUSING_'||BuildingType
...
SELECT	'MODIFIER_CVS_IMHOTEP_HOUSING_'||BuildingType,
